      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center">
            <a href="#home" className="text-white font-bold text-xl hover:text-gray-300 transition-colors">
              Portfolio
            </a>
          </div>
            ...
            <div className="px-2 pt-2 pb-3 space-y-1 bg-black">
              ...
              <div className="px-3 py-2">
                ...
                <div className="pl-4 space-y-1">
                  <a href="#web-apps" className="block px-3 py-1 text-sm text-gray-400 hover:text-gray-300 hover:bg-gray-900 rounded-md">
                    Web Applications
                  </a>
                  <a href="#mobile" className="block px-3 py-1 text-sm text-gray-400 hover:text-gray-300 hover:bg-gray-900 rounded-md">
                    Mobile Apps
                  </a>
                  <a href="#open-source" className="block px-3 py-1 text-sm text-gray-400 hover:text-gray-300 hover:bg-gray-900 rounded-md">
                    Open Source
                  </a>
                </div>
              </div>
              ...
              <div className="px-3 py-2">
                ...
                <div className="pl-4 space-y-1">
                  <a href="#frontend" className="block px-3 py-1 text-sm text-gray-400 hover:text-gray-300 hover:bg-gray-900 rounded-md">
                    Frontend Development
                  </a>
                  <a href="#backend" className="block px-3 py-1 text-sm text-gray-400 hover:text-gray-300 hover:bg-gray-900 rounded-md">
                    Backend Development
                  </a>
                  <a href="#consulting" className="block px-3 py-1 text-sm text-gray-400 hover:text-gray-300 hover:bg-gray-900 rounded-md">
                    Consulting
                  </a>
                </div>
              </div>
